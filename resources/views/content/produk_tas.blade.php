                                ...
                                <ul class="list">
                                    ...
                                    <li class="sub-menu">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="#Electronics">Gelang</a>
                                            </li>
                                            <li>
                                                <a href="#Electronics">Kalung</a>
                                            </li>
                                            <li>
                                                <a href="#Electronics">Anting</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <div class="col-lg-9">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single_category_product">
                                <div class="single_category_img">
                                    <img src="img/category/tas1.jpg" alt="">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single_category_product">
                                <div class="single_category_img">
                                    <img src="img/category/tas2.jpg" alt="">
                                    <div class="category_social_icon">
                                        <ul>
                                            <li><a href="#"><i class="ti-eye"></i></a></li>
                                            <li><a href="#"><i class="ti-shopping-cart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single_category_product">
                                <div class="single_category_img">
                                    <img src="img/category/tas3.jpg" alt="">
                                    <div class="category_social_icon">
                                        <ul>
                                            <li><a href="#"><i class="ti-eye"></i></a></li>
                                            <li><a href="#"><i class="ti-shopping-cart"></i></a></li>
